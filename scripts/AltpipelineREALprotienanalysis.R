# =============================================================================
# Alt-pipeline protien-coding QC steps
# =============================================================================
...
# Inputs
counts_file <- "D:/GroupA_University2026_Project/ALT_pipeline_data/protien_coding_gene_matrix.txt"
...
# Scatter plots with clean labels
...
nCount_upper <- 1200000    # Keep large cells, remove only extreme outliers
...
# After PCA)
saveRDS(seurat_obj, file = "seurat_protienpreprocessed.rds")
scaled_matrix <- GetAssayData(seurat_obj, layer = "scale.data")
saveRDS(scaled_matrix, file = "D:/GroupA_University2026_Project/OUTPUTS/seurat_protienmatrix.rds")
